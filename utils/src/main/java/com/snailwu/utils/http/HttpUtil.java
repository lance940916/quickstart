package com.snailwu.utils.http;
...
/**
 * 基于 Apache HttpClient 封装的 HttpClient
 *
 * @author 吴庆龙
...
public class HttpUtil {
     ...
     * 文本响应消息的处理器
     */
    private static final DefaultTextResponseHandler DEFAULT_TEXT_RESPONSE_HANDLER = new DefaultTextResponseHandler();
    ...
    public static String get(String uri) {
        ...
        try {
            return httpClient.execute(get, DEFAULT_TEXT_RESPONSE_HANDLER);
        } catch (IOException e) {
    ...
    public static String post(String uri, Map<String, String> urlParams, String bodyJsonContent) {
        ...
        // 请求
        try {
            return httpClient.execute(post, DEFAULT_TEXT_RESPONSE_HANDLER);
        } catch (IOException e) {
            log.error("[HTTP 请求]-请求异常. Msg:{}", e.getMessage());
        }
        return null;
     ...
     * 对于文本类型的响应封装处理
     */
    public static class DefaultTextResponseHandler implements ResponseHandler<String> {
        @Override
